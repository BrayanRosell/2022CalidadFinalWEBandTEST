...
namespace Finanzas.Controllers
{
    public class CuentaController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.Moneda = _context.GetMoneda();
            ViewBag.TotalSoles = cuentas.Where(o => o.IdMoneda == 1).Sum(o => o.Saldo);
            ViewBag.TotalDolares = cuentas.Where(o=>o.IdMoneda==2).Sum(o => o.Saldo);
            ViewBag.Total = cuentas.Where(o=>o.IdMoneda==2).Sum(o => o.Saldo);
